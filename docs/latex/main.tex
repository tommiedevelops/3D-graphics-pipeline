...
\begin{itemize}
	\item We can think of a modern computer as Memory, a Computation Unit and a Screen.
	\item A Graphics Engine is a process that allows a programmer to store 3D objects in memory, perform custom computation on those objects and render the objects to the screen.
\end{itemize}
